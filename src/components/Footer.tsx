...
export const Footer: FC<FooterProps> = ({ categories, language = "" }) => {
      ...
      <div className="flex flex-col gap-8 m-auto max-w-7xl">
        <div className="flex flex-col md:flex-row gap-8 justify-between">
          ...
          <div className="flex flex-col md:flex-row gap-5">
            <h3 className="font-poppins font-bold text-xl text-paper">{t("footer_categories")}</h3>
        ...
        <div className="flex flex-row gap-4 items-center justify-between">
          <p className="font-poppins text-paper text-sm md:text-base">{t("footer_description")}</p>
