...
const Heading = (props: React.DetailedHTMLProps<React.HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement> & { tag: HeadingTag }) => {
  const Tag = props.tag;
  ...
  return (
    <Tag {...props} id={props.id ?? text}>
      <a className="font-extrabold no-underline group text-gray-600 hover:text-gray-700" href={`#${text}`}>
...
export const MdxComponents = {
  ...
  p: (props: any) => <p className="leading-8 text-lg text-gray-700 my-7">{props.children}</p>,
  a: (props: any) => (
  ...
  blockquote: (props: any) => <div className=" border-gray-600 border-solid border-l-4 pl-3">{props.children}</div>,
  pre: (props: any) => {
  ...
  h2: (props: any) => <Heading {...props} tag="h2" className="text-3xl md:text-4xl my-3" />,
  h3: (props: any) => <Heading {...props} tag="h3" className="text-2xl md:text-3xl my-3" />,
  h4: (props: any) => <Heading {...props} tag="h4" className="text-xl md:text-2xl my-3" />,
  h5: (props: any) => <Heading {...props} tag="h5" className="text-lg md:text-xl my-3" />,
  h6: (props: any) => <Heading {...props} tag="h6" className="text-md md:text-lg my-3" />
};
